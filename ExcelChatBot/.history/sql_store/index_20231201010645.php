        ...
        <?php
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                    ...
                    {$row['status'] === "Active" ? <span class='bg-success rounded-circle d-inline-block p-2 m-0 position-absolute top-50 start-50 translate-middle'></span> :
                        <span class='bg-success rounded-circle d-inline-block p-2 m-0 position-absolute top-50 start-50 translate-middle'></span> }
                    </td>
